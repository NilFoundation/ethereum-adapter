...
func (api *ErigonImpl) GetLogsByHash(ctx context.Context, hash common.Hash, adapter replication_adapter.Adapter) ([][]*types.Log, error) {
...
func (api *ErigonImpl) GetBlockReceiptsByBlockHash(ctx context.Context, cannonicalBlockHash common.Hash, adapter replication_adapter.Adapter) ([]map[string]interface{}, error) {
	tx, err := api.db.BeginRo(ctx)
	if err != nil {
		return nil, err
	}
